...
% DO NOT EDIT!
                  README for GAP 4.4.11

These archives contain the current release of GAP. It is version
4.4.11.  They also contain a number of contributed
...
While the `gap4r4p11' archive must be unpacked *in* the directory
...
Decompress  'gap4r4p11-win.zip'   on  the  top-level  directory   of  drive  C:\.
This  creates  a  directory  C:\GAP4R4,   the  'GAP  root  directory'.  Then
extract  'packages...-win.zip' into  C:\GAP4R4\pkg\.   
Click  on C:\gap4r4p11\bin\gapw95.exe to start GAP.
...
Move this application and gap4r4p11.zoo  into the  folder in
which you want  to install  GAP and decompress  it by dragging it onto the
'unzoo' application icon.

.  This  should  have  created  a  folder  'gap4r4p11' with a 
