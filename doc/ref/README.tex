...
% DO NOT EDIT!
                  README for GAP 4.4.9

These archives contain the current release of GAP. It is version 4.4.9
...
You also will find copyright and license information on those web pages.
...
While the `gap4r4p9' archive must be unpacked *in* the directory
...
Decompress  'gap4r4p9-win.zip'   on  the  top-level  directory   of  drive  C:\.
This  creates  a  directory  C:\GAP4R4,   the  'GAP  root  directory'.  Then
extract  'packages...-win.zip' into  C:\GAP4R4\pkg\.   
Click  on C:\gap4r4p9\bin\gapw95.exe to start GAP.
...
Move this application and gap4r4p9.zoo  into the  folder in
which you want  to install  GAP and decompress  it by dragging it onto the
'unzoo' application icon.

.  This  should  have  created  a  folder  'gap4r4p9' with a 
