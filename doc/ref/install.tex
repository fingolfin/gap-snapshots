...
\beginitems
Unix, OS X&
Under Unix or OS X unpack the archive `gap4r4p8' in whatever
...
`unzoo 4.4 PPC'. 
Now move this applications, as well as the `gap4r4p8.zoo'
archive to the Folder in which you want to install {\GAP}. Drag the archive
`gap4r4p8.zoo onto the icon of `unzoo 4.4 PPC'. You will get a
...
archives we provide move `unzoo.exe' and  `gap4r4p8.zoo' in the
...
To extract the packages, extract the `package4r4p8' archive *in*
...
get the `htmie4r4p8' archive which provides math symbols in a
different encoding. (`Mozilla', `Konqueror' and `Safari' all support unicode
characters.)

The manual is also available in `pdf' format.
In the full UNIX
distribution (`gap4r4p8.zoo') these files are included in the
directory
`gap4r4/doc'  in the
...
folder you want to install {\GAP} 4.4.8.
...
distribution   `gap4r4p8.zoo' and the    binary    archive
`unzoo4r4-PPC.sit',
...
Move the file `gap4r4p8.zoo' into the folder `Applications'
...
(You will not need the file `gap4r4p8.zoo' any
