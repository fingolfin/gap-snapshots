...
%%
%A @(#)$Id: mloop.msk,v 1.30.2.4 2006/09/12 14:51:18 jjm Exp $
%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\Section{Special Rules for Input Lines}
...
see the last part (with a `\$' character in front). For nicer display you
...
with `gap> ', `> ' or `brk> ' this beginning part is removed. This rule is very convenient because it allows to cut and paste input from other {\GAP} sessions
...
options `-f' and `-n' respectively (see~"Command Line Options"), however
