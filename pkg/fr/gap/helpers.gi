...
##
#H   @(#)$Id: helpers.gi,v 1.123 2012/06/01 19:44:37 gap Exp $
##
...
if not IsBound(PqEpimorphism) then PqEpimorphism := fail; fi;
#!!! a hack; should exist in nql

if not IsBound(NqEpimorphismNilpotentQuotient) then NqEpimorphismNilpotentQuotient := fail; fi;
