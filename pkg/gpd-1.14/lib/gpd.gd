...
#A  FullIdentitySubgroupoid( <gpd> )  
#A  DiscreteIdentitySubgroupoid( <gpd> )  
## 
...
DeclareAttribute( "FullIdentitySubgroupoid", IsGroupoid );
DeclareAttribute( "DiscreteIdentitySubgroupoid", IsGroupoid );
