...
############################################################################# 
## 
#P  IsSinglePieceDomain( <dwo> )
#P  IsDiscreteDomainWithObjects( <dwo> ) 
...
#A  Arrowtail( <ewo> ) 
#A  Arrowhead( <ewo> ) 
##  ??  maybe these names should change again? 
DeclareOperation( "Arrowelt", [ IsMultiplicativeElementWithObjects ] ); 
DeclareOperation( "Arrowtail", [ IsMultiplicativeElementWithObjects ] ); 
DeclareOperation( "Arrowhead", [ IsMultiplicativeElementWithObjects ] ); 
