...
##  
gap> START_TEST( "Testing examples in Chapter 2 of the Gpd manual" );
...
gap> ##  in the function flip below t is a transformation on [1..4] 
gap> flip := function( t ) 
>     local i, j, k, L, L2, n; 
...
[ magma with objects homomorphism : M78 -> M78
    [ [ <mapping: m -> m >, [ -8, -7 ] ] ]
    , magma with objects homomorphism : [ [ smap, [ -11, -12, -13 ] ] ]
     ]
