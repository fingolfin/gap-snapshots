...
#M  Arrowhead
##
InstallMethod( Arrowelt, "generic method for a magma with objects element", 
    true, [ IsMultiplicativeElementWithObjects ], 0, e -> e![1] ); 

InstallMethod( Arrowtail, "generic method for a magma with objects element", 
    true, [ IsMultiplicativeElementWithObjects ], 0, e -> e![2] ); 

InstallMethod( Arrowhead, "generic method for a magma with objects element", 
...
#?            which is why there is a special IsElementInGroupoid in gpd.gi
