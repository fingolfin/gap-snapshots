#############################################################################
##
##  PackageInfo.g   file for the package XMod version 2.19  (09/06/12)
...
##  <!ENTITY VERSION "2.19">
##  <!ENTITY RELEASEDATE "09/06/2012">
##  <#/GAPDoc>

PackageWWWHome := 
  "http://www.math.bangor.ac.uk/chda/gap4r5/xmod/",

ArchiveURL := "http://www.math.bangor.ac.uk/chda/gap4r5/xmod/xmod-2.19", 
...
Dependencies := rec(
  GAP := ">=4.5",
  NeededOtherPackages := [ ["Gpd", ">= 1.15"], ["autpgrp", ">= 1.4"] ],
...
BannerString := Concatenation( 
  "Loading XMod ", String( ~.Version ), " for GAP 4.5", 
