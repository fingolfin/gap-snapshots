#############################################################################
##
##  PackageInfo.g   file for the package Gpd version 1.18  (25/01/13)
...
##  <!ENTITY VERSION "1.18">
##  <!ENTITY RELEASEDATE "25/01/2013">
##  <#/GAPDoc>

PackageWWWHome := 
 "http://www.maths.bangor.ac.uk/chda/gap4/gpd/",

ArchiveURL := "http://www.maths.bangor.ac.uk/chda/gap4/gpd/gpd-1.18", 
...
BannerString := Concatenation(
    "Loading Gpd ", String( ~.Version ), " for GAP 4.6", 
    " - Emma Moore and Chris Wensley ...\n" ),
