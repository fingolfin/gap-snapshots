    ...
    if Length( arg ) = 0 or IsFunction( arg[1] ) then
      ...
      t.work.Main:= function( t, i, j )
        ...
        if id in CTblLib.Data.IdEnumerator.identifiers then
          attr:= columns[j];
elif not id in CTblLib.Data.IdEnumeratorExt.identifiers then
Print( "not found: ", id, "\n" );
#T what to do in this case? viewValue returns nothing ...
...
#if not id in CTblLib.Data.IdEnumerator.identifiers 
#and attr.identifier = "Size" then
#Error("!");
#fi;
