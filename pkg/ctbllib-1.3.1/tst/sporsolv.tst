...
##  ./sporsolv.xml (964-969)
gap> LoadPackage( "CTblLib", "1.2", false );
true
gap> LoadPackage( "TomLib", false );
true

##  ./sporsolv.xml (978-980)
gap> MaxSolv:= rec();;

##  ./sporsolv.xml (1016-1050)
...
##  ./sporsolv.xml (1435-1438)
gap> MaxSolv.( "Suz" ):= n;;
gap> MaxSolv.( "Suz.2" ):= 2 * n;;

##  ./sporsolv.xml (1452-1461)
...
##  ./sporsolv.xml (1486-1489)
gap> MaxSolv.( "ON" ):= n;;
gap> MaxSolv.( "ON.2" ):= 2 * n;;

##  ./sporsolv.xml (1502-1515)
...
##  ./sporsolv.xml (1581-1583)
gap> MaxSolv.( "Co2" ):= n;;

##  ./sporsolv.xml (1598-1610)
...
##  ./sporsolv.xml (1643-1646)
gap> MaxSolv.( "Fi22" ):= n;;
gap> MaxSolv.( "Fi22.2" ):= 2 * n;;

##  ./sporsolv.xml (1660-1668)
...
##  ./sporsolv.xml (1691-1694)
gap> MaxSolv.( "HN" ):= n;;
gap> MaxSolv.( "HN.2" ):= 2 * n;;

##  ./sporsolv.xml (1708-1719)
...
##  ./sporsolv.xml (1745-1747)
gap> MaxSolv.( "Ly" ):= n;;

##  ./sporsolv.xml (1762-1773)
...
##  ./sporsolv.xml (1796-1798)
gap> MaxSolv.( "Th" ):= n;;

##  ./sporsolv.xml (1813-1822)
...
##  ./sporsolv.xml (1842-1844)
gap> MaxSolv.( "Fi23" ):= n;;

##  ./sporsolv.xml (1859-1873)
...
##  ./sporsolv.xml (1906-1908)
gap> MaxSolv.( "Co1" ):= n;;

##  ./sporsolv.xml (1923-1933)
...
##  ./sporsolv.xml (1999-2001)
gap> MaxSolv.( "J4" ):= n;;

##  ./sporsolv.xml (2016-2028)
...
##  ./sporsolv.xml (2060-2063)
gap> MaxSolv.( "Fi24'" ):= n;;
gap> MaxSolv.( "Fi24'.2" ):= 2 * n;;

##  ./sporsolv.xml (2086-2092)
...
##  ./sporsolv.xml (2274-2277)
gap> 2^(9+16+3+8) * 6 * 72 = n;
true

##  ./sporsolv.xml (2288-2294)
...
##  ./sporsolv.xml (2694-2697)
gap> n / MaxSolv.( "B" );
96

##  ./sporsolv.xml (2709-2712)
gap> Int( 3^8 * Size( CharacterTable( "O8-(3)" ) ) * 2 / n );
46

##  ./sporsolv.xml (2725-2732)
...
##  ./sporsolv.xml (2768-2770)
gap> MaxSolv.( "M" ):= n;;

##  ./sporsolv.xml (2813-2822)
