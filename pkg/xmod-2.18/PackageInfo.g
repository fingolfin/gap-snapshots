#############################################################################
##
##  PackageInfo.g   file for the package XMod version 2.18  (23/04/12)
...
ArchiveURL := "http://www.math.bangor.ac.uk/chda/gap4r5/xmod/xmod-2.18", 
...
Dependencies := rec(
  GAP := ">=4.5",
  NeededOtherPackages := [ ["Gpd", ">= 1.13"], ["autpgrp", ">= 1.4"] ],
