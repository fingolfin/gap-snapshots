...
#############################################################################
##
#0  IdentitySub3dGroup( <obj> ) 
#A  IdentitySubPreXSq( <obj> ) 
#A  IdentitySubXSq( <obj> ) 
#A  IdentitySubPreCat2( <obj> ) 
#A  IdentitySubCat2( <obj> ) 
#P  IsIdentityCat2( <C1G> )
##
DeclareOperation( "IdentitySub3dGroup", [ Is3dGroup ] );
DeclareAttribute( "IdentitySubPreXSq", IsPreXSq );
DeclareAttribute( "IdentitySubXSq", IsXSq );
DeclareAttribute( "IdentitySubPreCat2", IsPreCat2 );
DeclareAttribute( "IdentitySubCat2", IsCat2 );
