...
DeclareRepresentation( "IsFpWeightedDigraph",
    IsDigraph and IsComponentObjectRep, [ "vertices", "arcs" ] ); 
 
############################################################################# 
## 
#O  FpWeightedDigraphNC( <vertices>, <arcs> ) 
#O  FpWeightedDigraph( <vertices>, <arcs> )                                  
## 
...
DeclareRepresentation( "IsGraphOfGroupsRep",
    ...
    [ "DigraphOfGraphOfGroups", "GroupsOfGraphOfGroups", 
      "SubgroupsOfGraphOfGroups", "IsomorphismsOfGraphOfGroups" ] ); 
...
############################################################################# 
## 
#O  GraphOfGroupsNC( <dig>, <gps>, <subgps>, <isos> )                      
#O  GraphOfGroups( <dig>, <gps>, <subgps>, <isos> )                 
## 
