...
Print( "\n================================================================\n");
Print( "<<<< testing morphisms in the Gpd manual (version 12/01/12) >>>>\n" );
...
V3 := ReplaceOnePieceInUnion( U3, Gs4, Gs3 ); 
Print( "V3 = ", V3, "\n" ); 
Print( "\n" ); 
...
Print( "hs3c6 = ", hs3c6, "\n" ); 
e6 := GroupoidElement( Hc6, (5,6,7)(8,9), -4, -4 ); 
