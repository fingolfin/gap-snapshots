...
AUTODOC_file_scan_list := [ "../PackageInfo.g", "../examples/ArtinianModules.g", "../examples/Example.g", "../examples/FiniteZModules.g", "../examples/IntersectionCospan.g", "../examples/IntersectionSpan.g", "../examples/IntersectionThreeArrow.g", "../examples/IsSupportedInOrigin.g", "../examples/QuasiAffine.g", "../examples/Sweep.g", "../gap/GeneralizedMorphismCategory.gd", "../gap/GeneralizedMorphismCategory.gi", "../gap/GeneralizedMorphismCategoryByCospans.gd", "../gap/GeneralizedMorphismCategoryByCospans.gi", "../gap/GeneralizedMorphismCategoryBySpans.gd", "../gap/GeneralizedMorphismCategoryBySpans.gi", "../gap/GeneralizedMorphismCategoryByThreeArrows.gd", "../gap/GeneralizedMorphismCategoryByThreeArrows.gi", "../gap/GeneralizedMorphismCategoryFunctors.gd", "../gap/GeneralizedMorphismCategoryFunctors.gi", "../gap/SerreQuotientSubcategory.gd", "../gap/SerreQuotientSubcategory.gi", "../gap/SerreQuotients.gd", "../gap/SerreQuotients.gi", "../gap/SerreQuotientsByCospans.gd", "../gap/SerreQuotientsByCospans.gi", "../gap/SerreQuotientsBySpans.gd", "../gap/SerreQuotientsBySpans.gi", "../gap/SerreQuotientsByThreeArrows.gd", "../gap/SerreQuotientsByThreeArrows.gi", "../gap/SerreQuotientsFunctors.gd", "../gap/SerreQuotientsFunctors.gi", "../gap/Switcher.gd", "../gap/Switcher.gi", "../init.g", "../makedoc.g", "../read.g" ];
